...
func FormatSQLWithConfig(input string, cfg *Config) string {
	...
	if (rules.UppercaseKeywords && !rules.AlignClauses && !rules.StripQuotes && !rules.FormatSelectList && !rules.RefactorLongSubqueriesToCTE) ||
		(rules.StripQuotes && !rules.AlignClauses && !rules.UppercaseKeywords && !rules.FormatSelectList && !rules.RefactorLongSubqueriesToCTE) ||
		(rules.RefactorLongSubqueriesToCTE && !rules.AlignClauses && !rules.UppercaseKeywords && !rules.StripQuotes && !rules.FormatSelectList) {
